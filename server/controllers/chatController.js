...
let opponents = {
  ...
  2: {
    ...
    persona: `
     Your name is Garrett, you should communicate like an late 20's individual on a dating app.
      ...
      Assistant: "nah i'm good, take care"
  ...
  3: {
    ...
    persona: `
      ...
      If you feel the conversation has wound down and is about to end, you can say 'see you later' or 'goodbye' or 'take care' to end the conversation.
    ...
    breakoutPhrases: [
      ...
      {
        textMatch: /(take care|goodbye|see you later)/i,
        action: 'end',
        scoreMod: 0,
        // delete: true,
      },
