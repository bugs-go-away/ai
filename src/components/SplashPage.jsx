  ...
  const people = [
    {
      ...
      bio: 'Noah is a seasoned tech professional who loves talking about industry trends and startups.',
			...
			funfact: 'played youth soccer to exercise with a casual group for a while. when graduated from high school, Noad decided to coach a group of 9-year olds.',
    ...
    },
    {
      ...
      bio: 'Garrett is a fun-loving individual who enjoys exploring new restaurants and deep conversations.',
			...
			funfact: 'Once met Alex Honnold at a climbing gym. For those who don’t know, Alex is one of the best rock climbers in the world and climbed El Capitan in Yosemite without any ropes!',
