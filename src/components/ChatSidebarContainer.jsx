    ...
    <Box sx={{ width: 300,
      ...
      {person ? (
        <div className="p-4 bg-white shadow-md rounded-lg">
          ...
          <p className="text-sm text-gray-500 mb-2"><strong>Hobbies:</strong> {person.hobbies}</p>
					<p className="text-sm text-gray-500 mb-2"><strong>Fun fact:</strong> {person.funfact}</p>
        </div>
      ) : (
